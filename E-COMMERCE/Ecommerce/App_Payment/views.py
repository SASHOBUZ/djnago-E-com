...
# for payment Online Documentation from store_id >>>
...
def payment(request):
    ...
    store_id = 'green6362930c43dd8'
    API_key = 'green6362930c43dd8@ssl'
...
def complete(request):
    if request.method == 'POST' or request.method == 'post':
        ...
        if status == 'VALID':
            ...
            messages.warning(
                request, f"Your payment Failed. Pleasae Try Again... \n You will be redirected to Home Page...")
